...
function () {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      fetch(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.value).then(function (data) {
        return data.json();
      }).then(function (results) {
        console.log(results);
        _this.resultsDiv.innerHTML = "\n         <div class=\"row\">\n            <div class=\"one-third\">\n              <h2 class=\"search-overlay__section-title\">General Information</h2>\n              ".concat(results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>Sorry there is no general infornation related to this search</p>', "\n          ").concat(results.generalInfo.map(function (post) {
          return "\n            <li><a href=\"".concat(post.permalink, "\">").concat(post.title, "</a> ").concat(post.type === 'post' ? " by ".concat(post.author) : '', "</li>");
        }).join(''), "\n          ").concat(results.generalInfo.length ? '</ul>' : '', "\n          </div>\n            <div class=\"one-third\">\n              <h2 class=\"search-overlay__section-title\">Programs</h2>\n              ").concat(results.programs.length ? '<ul class="link-list min-list">' : "<p>Sorry there is no programs related to this search. <a href=\"".concat(universityData.root_url, "/programs\">View all programs.</a></p>"), "\n          ").concat(results.programs.map(function (post) {
          return "\n            <li><a href=\"".concat(post.permalink, "\">").concat(post.title, "</a></li>");
        }).join(''), "\n          ").concat(results.programs.length ? '</ul>' : '', "\n\n              <h2 class=\"search-overlay__section-title\">Professors</h2>\n              ").concat(results.professors.length ? '<ul class="professor-cards">' : "<p>Sorry there is no professors related to this search. </p>", "\n          ").concat(results.professors.map(function (post) {
          return "\n          <li class=\"professor-card__list-item\">\n\t\t\t<a class=\"professor-card\" href=\"".concat(post.permalink, "\">\n\t\t\t\t<img class=\"professor-card__image\" src=\"").concat(post.image, "\" alt=\"professor image\">\n\t\t\t\t<span class=\"professor-card__name\">").concat(post.title, "</span>\n\t\t\t</a>\n\t\t</li>\n            ");
        }).join(''), "\n          ").concat(results.professors.length ? '</ul>' : '', "\n\n            </div>\n            <div class=\"one-third\">\n              <h2 class=\"search-overlay__section-title\">Campuses</h2>\n              ").concat(results.campuses.length ? '<ul class="link-list min-list">' : "<p>Sorry there is no programs related to this search. <a href=\"".concat(universityData.root_url, "/campuses\">View all programs.</a></p>"), "\n          ").concat(results.campuses.map(function (post) {
          return "\n            <li><a href=\"".concat(post.permalink, "\">").concat(post.title, "</a></li>");
        }).join(''), "\n          ").concat(results.campuses.length ? '</ul>' : '', "\n\n              <h2 class=\"search-overlay__section-title\">Events</h2>\n              ").concat(results.events.length ? '' : "<p>Sorry there is no events related to this search. <a href=\"".concat(universityData.root_url, "/events\">View all programs.</a></p>"), "\n          ").concat(results.events.map(function (item) {
        ...
        _this.resultsDiv.innerHTML = "<p>Something went wrong! Please try again!</p>";
      });
      this.isSpinnerVisible = false;
    }
  }, {
